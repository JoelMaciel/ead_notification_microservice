...
import com.ead.notification.domain.exceptions.BusinessException;
import com.ead.notification.domain.exceptions.EntityInUseException;
import com.ead.notification.domain.exceptions.EntityNotFoundException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleSignatureException(SignatureException ex, WebRequest webRequest) {
        HttpStatus status = HttpStatus.UNAUTHORIZED;
        ProblemType problemType = ProblemType.UNAUTHORIZED;
        String detail = "Invalid JWT signature. The token's signature does not match the expected signature.";
